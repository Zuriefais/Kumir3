...
В отличии от большинства текстовых редакторов, редактор программ "Кумир" позволяет
            ...
            текстовых файлов (доступен только в конфигурациях**Профессиональнаяи**и**Для учителей) -- в произвольную ячейку текста.**) -- в произвольную ячейку текста.

**Профессиональная
            и**
и

**Для учителей) -- в произвольную ячейку текста.**
) -- в произвольную ячейку текста.
...
`:=`(оператор присваивания) -- с помощью комбинации клавишAlt+=
...
`|`(начало комментария) -- с помощью комбинации клавишAlt+1.
...
**Замечание.Данная возможность является экспериментальной и по умолчанию отключена. Для ее включения необходимо отметить
            флаг**Данная возможность является экспериментальной и по умолчанию отключена. Для ее включения необходимо отметить
...
Автоматически дописывать конструкции программы
, который находится в
            разделе
...
РедактированиеЗаменить
открывает

область поиска и замены
.
...
**обычный-- содержит только поиск,**-- содержит только поиск,
...
**расширенный-- содержит поиск по шаблону и замену.**-- содержит поиск по шаблону и замену.

**расширенный -- содержит поиск по шаблону и замену.**
-- содержит поиск по шаблону и замену.
...
В том случае, если необходимо скопировать только текст программыбез форматирования и текста на полях,
            то вставка текста в RickText-редактор выполняется командой,
...
без форматирования и текста на полях,
            то вставка текста в RickText-редактор выполняется командой
,
            то вставка текста в RickText-редактор выполняется командой
