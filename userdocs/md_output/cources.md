...
При прохождении (выполнении) курса учеником, МПП для каждого задания помнит текущую *оценку*-- целое число от
...
Задание может содержать несколько обстановок исполнителей. Для проверки текущей программы необходимо нажать кнопку *Подготовка тестирующего алгоритма*.
...
тестирующий алгоритм-функция без параметров

.
Заголовок должен быть виден ученику, а алгоритм
